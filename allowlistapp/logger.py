"""Setup the logger functionality for allowlistapp."""
...
# root_logger : root,
# app.logger  : root, allowlistapp,
# logger      : root, allowlistapp, allowlistapp.module_name,
...
def setup_logger(app: Flask, logging_conf: dict, in_logger: logging.Logger | None = None) -> None:
    """Setup the logger, set config per ala_conf."""
