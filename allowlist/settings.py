...
class AllowListAppSettings:
    def __init__(self):
        ...
        try:
            ...
            self.password_hashsed = settings_temp["password_hashsed"]
        ...
        self.password_cleartext, self.password_hashsed = check_password(self)
        write_settings(self)


def check_password(ala_settings):
    # Settings File
    if ala_settings.password_cleartext == "" and ala_settings.password_hashsed == "":
    ...
    if ala_settings.password_cleartext != "":
        ...
        ala_settings.password_hashsed = hashed
        ala_settings.password_cleartext = ""
    elif ala_settings.password_hashsed == "":
        print("❌ No hashed password") # TODO This will never reach yeah?
    else:
        print("Found hashed password, probably")

    return ala_settings.password_cleartext, ala_settings.password_hashsed
